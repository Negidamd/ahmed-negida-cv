            ...
            <div className="text-center lg:text-left text-white animate-fade-in lg:pl-8" style={{ animationDelay: '0.2s' }}>
              ...
              <div className="space-y-5 mb-8 text-white/90 text-base lg:text-lg leading-relaxed font-normal max-w-3xl">
                <p className="leading-loose">
                  Dr. Ahmed Negida is a translational research scientist working on
                  neurodegenerative diseases. He integrates multimodal brain imaging—structural
                  ...
                  and Alzheimer's, and to optimize patient selection for disease-modifying clinical trials.
                </p>
                <p className="leading-loose">
